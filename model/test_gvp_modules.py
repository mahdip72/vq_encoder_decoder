...
if __name__ == '__main__':
    ...
    dataset = ProteinGraphDataset(configs.train_settings.data_path,
    ...
    val_loader = DataLoader(dataset, batch_size=configs.train_settings.batch_size, num_workers=0, pin_memory=True,
