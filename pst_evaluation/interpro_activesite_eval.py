...
def parse_args():
    p = argparse.ArgumentParser(description="InterPro active site AUROC eval (minimal)")
    p.add_argument(
        "--h5",
        required=True,
        help="Path to InterPro active-site H5 (e.g., vq_embed_interpro_activesite_lite.h5)",
    )
    p.add_argument(
        "--embeddings-dataset",
        default="/",
...
def main():
    ...
    logger = logging.getLogger("interpro_activesite_eval")
