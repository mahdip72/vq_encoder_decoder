...
try:  # ImportError-safe in trimmed fork
    from proteinworkshop.configs.config import ExperimentConfigurationError
except ModuleNotFoundError:  # pragma: no cover - fallback for lightweight package
    class ExperimentConfigurationError(RuntimeError):
        """Raised when an unsupported structural representation is requested."""
