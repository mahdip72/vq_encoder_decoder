...
from .decoders import GeometricDecoder
from .gcpnet.models.base import instantiate_encoder, load_pretrained_encoder
from .protein_encoder import ProteinEncoder
from .utils import merge_features, separate_features
...
def prepare_model(configs, logger, *, log_details=False, **kwargs):
    ...
    if not kwargs.get("decoder_only", False):
        ...
        if configs.model.encoder.name == "gcpnet":
            encoder_config_path = kwargs.get("encoder_config_path")
