...
def _import_from_string(path: str) -> Any:
    if path.startswith("models.gcpnet."):
        path = "gcp_vqvae._internal.models.gcpnet." + path[len("models.gcpnet."):]
    elif path == "models.gcpnet":
        path = "gcp_vqvae._internal.models.gcpnet"
    if "." not in path:
